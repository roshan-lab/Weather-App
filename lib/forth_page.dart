...
class _ForthPageState extends State<ForthPage> {
  ...
  Future getWeather() async {
    http.Response response = await http.get(Uri.parse(
        "https://api.openweathermap.org/data/2.5/weather?q=chennai&appid=6152c729e0820df5a5634bb6bd5c92e9"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Stack(
          children: <Widget>[
            Image.asset("assets/chennai.jpg",
              fit: BoxFit.cover,
...
class WeatherPage4 extends StatelessWidget {
  const WeatherPage4({Key? key}) : super(key: key);
