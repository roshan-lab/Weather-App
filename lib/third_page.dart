...
class _ThirdPageState extends State<ThirdPage> {
  ...
  Future getWeather() async {
    http.Response response = await http.get(Uri.parse(
        "https://api.openweathermap.org/data/2.5/weather?q=kolkata&appid=6152c729e0820df5a5634bb6bd5c92e9"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Stack(
          children: <Widget>[
            Image.asset("assets/kolkata.jpg",
              fit: BoxFit.cover,
...
class WeatherPage3 extends StatelessWidget {
  const WeatherPage3({Key? key}) : super(key: key);
